...
# which contains all participants who obtained an IOlympic mdal
# Source Kaggle; https://www.kaggle.com/the-guardian/olympic-games
#-----------------------------------------------------------------------

#################################################################################################
# Finally, this data set was transformed but not used in the project as the athletes data set
# is a superset of it
#################################################################################################
